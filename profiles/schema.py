...
class ProfileNode(RestrictedProfileNode):
    ...
    @staticmethod
    def _filter_loging_methods(user_uuid, extended=False) -> Iterable:
    ...
    def resolve_login_methods(self: Profile, info, **kwargs):
        ...
        if ProfileNode._has_correct_amr_claim(amr):
            return ProfileNode._filter_loging_methods(self.user.uuid, extended=False)
        return []
    ...
    def resolve_available_login_methods(self: Profile, info, **kwargs):
        ...
        if ProfileNode._has_correct_amr_claim(amr):
            return ProfileNode._filter_loging_methods(self.user.uuid, extended=True)
        return []
