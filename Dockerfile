...
COPY ./hdiv_agent-1.0.0.dev2-cp37-cp37m-manylinux2014_x86_64.whl /root
...
RUN apt-install.sh \
    ...
    && pip install --ignore-installed /root/hdiv_agent-1.0.0.dev2-cp37-cp37m-manylinux2014_x86_64.whl \
